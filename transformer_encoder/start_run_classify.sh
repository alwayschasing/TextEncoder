...
train_data="/search/odin/liruihong/TextEncoder/data_sets/fuse_data/labeledsentence_pair_train.tsv"
#train_data="/search/odin/liruihong/TextEncoder/data_sets/fuse_data/test.tsv"
#dev_data="/search/odin/liruihong/TextEncoder/data_sets/fuse_data/test.tsv"
dev_data="/search/odin/liruihong/TextEncoder/data_sets/fuse_data/labeledsentence_pair_dev.tsv"
...
cached_data="/search/odin/liruihong/TextEncoder/cached_data/transformer_encoder/labeledcached_fuse_data.train"
...
model_output_dir="/search/odin/liruihong/TextEncoder/model_output/bert-reduce/labeled-fuse-data-epoch10-new"
init_model="/search/odin/liruihong/TextEncoder/model_output/bert-reduce/labeled-fuse-data-epoch5-new"

python labeled_text_similarity.py \
    --gpu_id="3" \
