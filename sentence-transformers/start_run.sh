...
model_output_dir="/search/odin/liruihong/TextEncoder/model_output/bert-base/fuse-data-epoch10-utf8"

python TextSimilarity.py \
    --model_name="/search/odin/zhuguangnan/SBERT/trans_data/bert_base_chinese/" \
